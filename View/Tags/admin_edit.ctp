<div class="row">
    <div class="col-md-9">
        ...
        ?>        <fieldset>
            <legend><?=__('Admin Edit %s', __('Tag')); ?></legend>
            				<?php
    ...
    <div class="col-md-3">
        <div class="panel panel-default">
            ...
            <ul class="list-group">
                                    <li class="list-group-item"><?=$this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Tag.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Tag.id'))); ?></li>

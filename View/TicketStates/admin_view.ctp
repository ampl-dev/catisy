<div class="row">
    <div class="col-md-9">
        <h1><?= $ticketState['TicketState']['name']?></h1>
        <dl class="dl-horizontal">
            			<dt><?=__('Id'); ?></dt>
			<dd>
				<?=h($ticketState['TicketState']['id']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Name'); ?></dt>
			<dd>
				<?=h($ticketState['TicketState']['name']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Slug'); ?></dt>
			<dd>
				<?=h($ticketState['TicketState']['slug']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Created'); ?></dt>
			<dd>
				<?=h($ticketState['TicketState']['created']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Modified'); ?></dt>
			<dd>
				<?=h($ticketState['TicketState']['modified']); ?>
				&nbsp;
			</dd>
        </dl>
    </div>
    ...
    <div class="col-md-3">
        <div class="panel panel-default">
            ...
            <!-- List group -->
            <ul class="list-group">
                    			<li class="list-group-item"><?=$this->Html->link(__('Edit %s', __('Ticket State')), array('action' => 'edit', $ticketState['TicketState']['id'])); ?> </li>
			<li class="list-group-item"><?=$this->Form->postLink(__('Delete %s', __('Ticket State')), array('action' => 'delete', $ticketState['TicketState']['id']), null, __('Are you sure you want to delete # %s?', $ticketState['TicketState']['id'])); ?> </li>
    ...
    <?php if (!empty($ticketState['Ticket'])):?>
            <table class="table">
                <tr>
                    				<th><?=__('Id'); ?></th>
				<th><?=__('Project Id'); ?></th>
				...
				<th><?=__('Deleted'); ?></th>
                    <th class="actions"><?=__('Actions');?></th>
                		...
                		<?php foreach ($ticketState['Ticket'] as $ticket): ?>
			<tr>
				<td><?=$ticket['id'];?></td>

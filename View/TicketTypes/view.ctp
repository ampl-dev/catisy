<div class="row">
    <div class="col-md-9">
        <h1><?= $ticketType['TicketType']['name']?></h1>
        <dl class="dl-horizontal">
            			<dt><?=__('Id'); ?></dt>
			<dd>
				<?=h($ticketType['TicketType']['id']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Name'); ?></dt>
			<dd>
				<?=h($ticketType['TicketType']['name']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Slug'); ?></dt>
			<dd>
				<?=h($ticketType['TicketType']['slug']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Created'); ?></dt>
			<dd>
				<?=h($ticketType['TicketType']['created']); ?>
				&nbsp;
			</dd>
			<dt><?=__('Modified'); ?></dt>
			<dd>
				<?=h($ticketType['TicketType']['modified']); ?>
				&nbsp;
			</dd>
        </dl>
    </div>
    ...
    <div class="col-md-3">
        <div class="panel panel-default">
            ...
            <!-- List group -->
            <ul class="list-group">
                    			<li class="list-group-item"><?=$this->Html->link(__('Edit %s', __('Ticket Type')), array('action' => 'edit', $ticketType['TicketType']['id'])); ?> </li>
			<li class="list-group-item"><?=$this->Form->postLink(__('Delete %s', __('Ticket Type')), array('action' => 'delete', $ticketType['TicketType']['id']), null, __('Are you sure you want to delete # %s?', $ticketType['TicketType']['id'])); ?> </li>
            ...
            <table class="table">
				...
				<th><?=__('Deleted'); ?></th>
                    <th class="actions"><?=__('Actions');?></th>
                		...
                		<?php foreach ($ticketType['Ticket'] as $ticket): ?>
			<tr>
				<td><?=$ticket['id'];?></td>

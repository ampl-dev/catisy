<div class="row">
    ...
    <div class="col-md-3">
        <div class="panel panel-default">
            ...
            <!-- List group -->
            <ul class="list-group">
                    			<li class="list-group-item"><?=$this->Html->link(__('Edit %s', __('Epic')), array('action' => 'edit', $epic['Epic']['id'])); ?> </li>
			<li class="list-group-item"><?=$this->Form->postLink(__('Delete %s', __('Epic')), array('action' => 'delete', $epic['Epic']['id']), null, __('Are you sure you want to delete # %s?', $epic['Epic']['id'])); ?> </li>
            ...
            <table class="table">
				...
				<th><?=__('Deleted'); ?></th>
                    <th class="actions"><?=__('Actions');?></th>
                		...
                		<?php foreach ($epic['Ticket'] as $ticket): ?>
			<tr>
				<td><?=$ticket['id'];?></td>
